...
// Utilizando filter()
const empregados = usuarios.filter(usuarios => (
...
// Unindo Operações...
const newUserAges = [
    { nome: 'Diego', idade: 23 * 2, empresa: 'Rocketseat' },
    { nome: 'Gabriel', idade: 15 * 2, empresa: 'Rocketseat' },
    { nome: 'Lucas', idade: 30 * 2, empresa: 'Facebook' },
   ];
